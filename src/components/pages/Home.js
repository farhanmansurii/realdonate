    ...
    <div>
      ...
      <div className="normal" data-aos="fade-down" data-aos-delay="100" style={{ backgroundColor: "#FFFFFF", paddingTop: "100px", paddingBottom: "100px" }}>
        <div className="page_inner_div">
          <h1 style={{ fontWeight: "900", color: "#263238", marginTop: "30px" }} id="responsive_h1" data-aos="zoom-in" data-aos-delay="100">Donation</h1>
          ...
          <Button variant="outline-secondary" href="https://www.gofundme.com/f/Donation?=customer&utm_medium=copy_link&utm_campaign=p_cf+share-flow-1">GoFundme</Button>{' '}
      ...
      <div className="normal" style={{ backgroundColor: "#FFFFFF", paddingTop: "100px", paddingBottom: "100px" }}>
        ...
        <p id="responsive_h7" style={{ color: "#66615b", padding: "10px 90px 30px 90px" }} data-aos="right" data-aos-delay="100">
          Members of Donation will receive numerous perks on their
          ...
          Give back by making Donation.com a mainstay in your giving
            mission.</p>
        <div className="page_inner_div">
